...
<Box sx={{ width: '100%' }}>
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
        ...
        <div className='menubglist'> <h6><LazyLoadImage  className='menulist ' src={din1} alt={din1} /> yellow rice <br/> with chicken </h6></div>
        <div className='menubglist'><h6> <LazyLoadImage className='menulist' src={din2} alt={din2} /> fried rice <br/> with chicken  </h6> </div>
        <div className='menubglist'><h6> <LazyLoadImage  className='menulist' src={din4} alt={din4} /> <br/>  </h6> </div>
        </Grid>
        <Grid item xs={12} sm={6}>
        <div className='menubglist'><h6><LazyLoadImage  className='menulist' src={din3} alt={din3} /> brown rice <br/> with bbq chicken  </h6> </div>
        <div className='menubglist'><h6><LazyLoadImage  className='menulist' src={macaroni} alt={macaroni}/> macaroni dish <br/> with grilled chicken </h6> </div>
        </Grid>
      </Grid>
    </Box>  </div>
